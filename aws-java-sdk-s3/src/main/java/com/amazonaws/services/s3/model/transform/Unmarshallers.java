...
public class Unmarshallers {
    ...
    public static final class SearchMatadataResponseUnmarshaller implements Unmarshaller<SearchMetadataResponse, InputStream> {

		private final boolean shouldSDKDecodeResponse;

		public SearchMatadataResponseUnmarshaller(final boolean shouldSDKDecodeResponse) {
			this.shouldSDKDecodeResponse = shouldSDKDecodeResponse;
		}

		public SearchMetadataResponse unmarshall(InputStream in) throws Exception {
			return new XmlResponsesSaxParser().parseSearchMetadataResponse(in, shouldSDKDecodeResponse)
